...
class PatientController {
  ...
  async createPatient(req, res, next) {
    try {
      ...
      // Create patient
      const patient = await Patient.create(phone, email);
  ...
  async rejoinQueue(req, res, next) {
    try {
      ...
      // Create new patient with same phone/email if exists
      const newPatient = await Patient.create(patient.phone, patient.email);
